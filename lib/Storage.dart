...
class Task {
  ...
  Task({required this.title, required this.description, this.status="pending"});
  ...
  Future<void> fetchTasks()async {
    ...
    print("value   KAERGTGTYV is ${v1}");
     ...
     for(int i=0 ; v1!=null&&i<v1.length  ; i++){
       ...
       _taskList.add(Task(title: v1[i]["title"], description: v1[i]["description"],status: v1[i]["status"]));
